...
public class PokecLoader {
  ...
  private static String[] COLUMNS = new String[] { "id", "public", "completion_percentage", "gender", "region", "last_login",
      "registration", "age", "body", "I_am_working_in_field", "spoken_languages", "hobbies", "I_most_enjoy_good_food", "pets", "body_type",
      "my_eyesight", "eye_color", "hair_color", "hair_type", "completed_level_of_education", "favourite_color", "relation_to_smoking",
      ...
      "fun	I_am_going_to_concerts", "my_active_sports", "my_passive_sports", "profession", "I_like_books", "life_style", "music", "cars",
      "politics", "relationships", "art_culture", "hobbies_interests", "science_technologies", "computers_internet", "education", "sport",
...
//    InputStream gzipStream = new GZIPInputStream(fileStream);
    ...
    for (int i = 0; buffered.ready(); ++i) {
      ...
      db.async()
          .newEdgeByKeys("V", new String[] { "id" }, new Object[] { id1 }, "V", new String[] { "id" }, new Object[] { id2 }, false, "E",
              true, null);
