...
public class IndexFactory {
  ...
  public Index createIndex(final String indexType, final Database database, final String indexName, final boolean unique, final String filePath,
      final PaginatedFile.MODE mode, final String[] propertyNames, final byte[] keyTypes, final int pageSize) throws IOException {
    ...
    return handler.create(database, indexName, unique, filePath, mode, propertyNames, keyTypes, pageSize);
  }
}
