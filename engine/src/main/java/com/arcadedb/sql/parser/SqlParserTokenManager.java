...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 64:
         return jjStartNfaWithStates_0(0, 188, 1057);
      case 91:
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1122:
                  if (curChar == 45)
                     jjCheckNAddTwoStates(1123, 1126);
                  break;
               case 1123:
                  if ((0x3fe000000000000L & l) == 0L)
                     break;
               ...
               case 1137:
                  if ((0xff000000000000L & l) != 0L)
                     jjCheckNAddTwoStates(1138, 1134);
                  break;
               case 1138:
                  if ((0xff000000000000L & l) != 0L)
                     jjCheckNAdd(1134);
               ...
               case 1162:
                  ...
                  if (kind > 164)
                     kind = 164;
                  jjCheckNAddTwoStates(1162, 1106);
                  break;
               case 1163:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 164)
                     kind = 164;
                  jjCheckNAddTwoStates(1163, 1106);
                  break;
               case 1165:
                  if ((0x3ff000000000000L & l) != 0L)
                     jjAddStates(112, 113);
...
static final int[] jjnextStates = {
   33, 35, 36, 1119, 1120, 1131, 1157, 1159, 1108, 1118, 1107, 1108, 1118, 1153, 1155, 1120, 
   1131, 52, 53, 17, 56, 57, 60, 61, 1150, 1151, 1152, 1156, 1133, 1135, 1141, 1142, 
   1144, 19, 20, 22, 1105, 1106, 1107, 1108, 1118, 1119, 1120, 1131, 1161, 1163, 1106, 1164, 
   1171, 1157, 1159, 1108, 1118, 1153, 1155, 1120, 1131, 13, 14, 17, 19, 20, 24, 22, 
   52, 53, 17, 62, 63, 17, 327, 308, 362, 343, 398, 379, 1021, 1024, 1025, 1027, 
   1023, 1110, 1111, 1114, 1115, 1117, 1113, 1122, 1123, 1126, 1127, 1129, 1125, 1141, 1142, 1144, 
   1141, 1142, 1146, 1144, 1154, 1120, 1131, 1155, 1120, 1131, 1158, 1108, 1118, 1159, 1108, 1118, 
   1165, 1166, 1172, 1173, 1174, 1057, 1061, 1064, 1068, 1075, 1078, 1081, 1084, 1089, 1096, 1101, 
   1029, 1033, 1036, 1038, 1043, 1046, 1053, 946, 947, 951, 956, 968, 974, 989, 993, 996, 
   1002, 1007, 1015, 937, 941, 916, 919, 925, 928, 931, 934, 881, 882, 886, 891, 892, 
   894, 901, 908, 814, 819, 824, 829, 833, 842, 854, 860, 865, 868, 875, 878, 764, 
   766, 773, 779, 789, 796, 805, 730, 732, 734, 736, 737, 741, 748, 752, 761, 713, 
   717, 721, 724, 677, 680, 688, 691, 695, 702, 708, 653, 658, 663, 668, 673, 604, 
   607, 615, 621, 630, 635, 641, 647, 589, 594, 598, 502, 507, 514, 520, 523, 533, 
   543, 546, 553, 559, 566, 575, 400, 405, 411, 415, 420, 426, 431, 437, 441, 448, 
   458, 468, 478, 490, 227, 232, 235, 243, 247, 248, 254, 263, 264, 272, 281, 282, 
   291, 296, 328, 363, 195, 199, 203, 210, 217, 220, 163, 170, 171, 177, 180, 184, 
   191, 67, 72, 74, 77, 84, 92, 101, 107, 115, 124, 129, 133, 138, 145, 149, 
   154, 159, 15, 16, 21, 23, 25, 54, 55, 58, 59, 64, 65, 1136, 1137, 1139, 
   1143, 1145, 1147, 1167, 1168, 1169, 1170, 1175, 1176, 
};
...
static final long[] jjtoToken = {
   0xfffffffffffff801L, 0xffffffffffffffffL, 0xffffe1101fffffffL, 0x7fffffffffffffffL, 
   0xeL, 
};
...
private final int[] jjstateSet = new int[2354];
