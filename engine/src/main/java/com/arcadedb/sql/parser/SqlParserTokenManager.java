...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 45:
         jjmatchedKind = 207;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x0L, 0x1002000L, 0x0L);
      case 46:
         jjmatchedKind = 186;
      ...
      case 64:
         return jjStartNfaWithStates_0(0, 187, 1054);
      case 91:
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1119:
                  if (curChar == 45)
                     jjCheckNAddTwoStates(1120, 1123);
                  break;
               case 1120:
                  if ((0x3fe000000000000L & l) == 0L)
                     break;
               ...
               case 1134:
                  if ((0xff000000000000L & l) != 0L)
                     jjCheckNAddTwoStates(1135, 1131);
                  break;
               case 1135:
                  if ((0xff000000000000L & l) != 0L)
                     jjCheckNAdd(1131);
               ...
               case 1159:
                  ...
                  if (kind > 163)
                     kind = 163;
                  jjCheckNAddTwoStates(1159, 1103);
                  break;
               case 1160:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 163)
                     kind = 163;
                  jjCheckNAddTwoStates(1160, 1103);
                  break;
               case 1162:
                  if ((0x3ff000000000000L & l) != 0L)
                     jjAddStates(112, 113);
...
static final int[] jjnextStates = {
   33, 35, 36, 54, 55, 17, 58, 59, 62, 63, 1147, 1148, 1149, 1153, 1130, 1132, 
   1138, 1139, 1141, 19, 20, 22, 1102, 1103, 1104, 1105, 1115, 1116, 1117, 1128, 1158, 1160, 
   1103, 1161, 1168, 1154, 1156, 1105, 1115, 1150, 1152, 1117, 1128, 1116, 1117, 1128, 1154, 1156, 
   1105, 1115, 1104, 1105, 1115, 1150, 1152, 1117, 1128, 13, 14, 17, 19, 20, 24, 22, 
   54, 55, 17, 64, 65, 17, 331, 312, 366, 347, 402, 383, 1018, 1021, 1022, 1024, 
   1020, 1107, 1108, 1111, 1112, 1114, 1110, 1119, 1120, 1123, 1124, 1126, 1122, 1138, 1139, 1141, 
   1138, 1139, 1143, 1141, 1151, 1117, 1128, 1152, 1117, 1128, 1155, 1105, 1115, 1156, 1105, 1115, 
   1162, 1163, 1169, 1170, 1171, 1054, 1058, 1061, 1065, 1072, 1075, 1078, 1081, 1086, 1093, 1098, 
   1026, 1030, 1033, 1035, 1040, 1043, 1050, 943, 944, 948, 953, 965, 971, 986, 990, 993, 
   999, 1004, 1012, 934, 938, 913, 916, 922, 925, 928, 931, 878, 879, 883, 888, 889, 
   891, 898, 905, 811, 816, 821, 826, 830, 839, 851, 857, 862, 865, 872, 875, 761, 
   763, 770, 776, 786, 793, 802, 727, 729, 731, 733, 734, 738, 745, 749, 758, 710, 
   714, 718, 721, 674, 677, 685, 688, 692, 699, 705, 650, 655, 660, 665, 670, 601, 
   604, 612, 618, 627, 632, 638, 644, 586, 591, 595, 506, 511, 517, 520, 530, 540, 
   543, 550, 556, 563, 572, 404, 409, 415, 419, 424, 430, 435, 441, 445, 452, 462, 
   472, 482, 494, 231, 236, 239, 247, 251, 252, 258, 267, 268, 276, 285, 286, 295, 
   300, 332, 367, 192, 196, 200, 207, 214, 221, 224, 160, 167, 168, 174, 177, 181, 
   188, 69, 74, 76, 79, 86, 94, 103, 109, 117, 126, 130, 135, 142, 146, 151, 
   156, 15, 16, 21, 23, 25, 56, 57, 60, 61, 66, 67, 1133, 1134, 1136, 1140, 
   1142, 1144, 1164, 1165, 1166, 1167, 1172, 1173, 
};
...
static final long[] jjtoToken = {
   0xfffffffffffff801L, 0xffffffffffffffffL, 0xfffff0880fffffffL, 0x3fffffffffffffffL, 
   0x7L, 
};
...
private final int[] jjrounds = new int[1174];
private final int[] jjstateSet = new int[2348];
