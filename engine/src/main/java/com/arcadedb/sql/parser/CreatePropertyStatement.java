...
//    OClassEmbedded typez = (OClassEmbedded) db.getMetadata().getSchema().getClass(className.getStringValue());
//    if (typez == null) {
//      throw new PCommandExecutionException("Type not found: " + className.getStringValue());
//    }
//    if (typez.getProperty(propertyName.getStringValue()) != null) {
//      if (ifNotExists) {
//        return;
//      }
...
//    }
//    // CREATE IT LOCALLY
//    OPropertyImpl internalProp = (OPropertyImpl) typez.addProperty(propertyName.getStringValue(), type, linkedType, linkedClass, unsafe);
