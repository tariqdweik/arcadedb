...
import com.arcadedb.sql.function.conversion.OSQLMethodAsDate;
import com.arcadedb.sql.function.conversion.OSQLMethodAsDateTime;
import com.arcadedb.sql.function.conversion.OSQLMethodAsDecimal;
import com.arcadedb.sql.function.conversion.OSQLMethodConvert;
...
public class ODefaultSQLMethodFactory implements OSQLMethodFactory {
  ...
  @Override
  public OSQLMethod createMethod(final String name) throws PCommandExecutionException {
    ...
    if (m instanceof Class<?>)
      try {
        ...
        throw new PCommandExecutionException("Cannot create SQL method: " + m, e);
      }
    else
      method = (OSQLMethod) m;

    if (method == null)
      throw new PCommandExecutionException("Unknown method name: " + name);
