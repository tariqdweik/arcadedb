...
public class OMultiValue {
  ...
  public static boolean isMultiValue(final Class<?> iType) {
    return Collection.class.isAssignableFrom(iType) || iType.isArray() || Map.class.isAssignableFrom(iType) || PMultiIterator.class
        .isAssignableFrom(iType) || (Iterable.class.isAssignableFrom(iType) && !(PIdentifiable.class.isAssignableFrom(iType)))
  ...
  public static Object getFirstValue(final Object iObject) {
    ...
    try {
      ...
      // IGNORE IT
      PLogManager.instance().debug(iObject, "Error on reading the first item of the Multi-value field '%s'", iObject, e);
    }
  ...
  public static Object getLastValue(final Object iObject) {
    ...
    try {
      ...
      // IGNORE IT
      PLogManager.instance().debug(iObject, "Error on reading the last item of the Multi-value field '%s'", iObject, e);
    }
  ...
  public static Iterable<Object> getMultiValueIterable(final Object iObject) {
    ...
    if (iObject instanceof Iterable<?>)
      ...
      return new PIterableObjectArray<>(iObject);
    ...
    return new PIterableObject<Object>(iObject);
  }
  ...
  public static Iterable<Object> getMultiValueIterable(final Object iObject, final boolean iForceConvertRecord) {
    ...
    if (iObject instanceof Iterable<?>)
      ...
      return new PIterableObjectArray<Object>(iObject);
    else if (iObject instanceof Iterator<?>) {
  ...
  public static Iterator<Object> getMultiValueIterator(final Object iObject, final boolean iForceConvertRecord) {
    ...
    if (iObject.getClass().isArray())
      return new PIterableObjectArray<Object>(iObject).iterator();
  ...
  public static Object remove(Object iObject, Object iToRemove, final boolean iAllOccurrences) {
    if (iObject != null) {
      if (iObject instanceof PMultiIterator<?>) {
        final Collection<Object> list = new LinkedList<Object>();
        for (Object o : ((PMultiIterator<?>) iObject))
          list.add(o);
        iObject = list;
      }

      if (iToRemove instanceof PMultiIterator<?>) {
        // TRANSFORM IN SET ONCE TO OPTIMIZE LOOPS DURING REMOVE
        final Set<Object> set = new HashSet<Object>();
        for (Object o : ((PMultiIterator<?>) iToRemove))
          set.add(o);
        iToRemove = set;
      }
  ...
  public static <T> T[] array(final Object iValue, final Class<? extends T> iClass, final PCallable<Object, Object> iCallback) {
    if (iValue == null)
      return null;
  ...
  public static Object convert(final Object iObject, final PCallable<Object, Object> iCallback) {
  ...
  public static Object toSet(final Object o) {
    if (o instanceof Set<?>)
      ...
      return set;
    } else if (o instanceof Iterable && !(o instanceof PIdentifiable)) {
