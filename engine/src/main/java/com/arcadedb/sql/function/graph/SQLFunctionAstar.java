    ...
    if (mapParams != null) {
      ...
      if (mapParams.get(SQLFunctionAstar.PARAM_DIRECTION) != null) {
        if (mapParams.get(SQLFunctionAstar.PARAM_DIRECTION) instanceof String) {
          ctx.paramDirection = Vertex.DIRECTION
              .valueOf(stringOrDefault(mapParams.get(SQLFunctionAstar.PARAM_DIRECTION), "OUT").toUpperCase(Locale.ENGLISH));
        } else {
      ...
      ctx.paramEmptyIfMaxDepth = booleanOrDefault(mapParams.get(SQLFunctionAstar.PARAM_EMPTY_IF_MAX_DEPTH),
      ...
      if (mapParams.get(SQLFunctionAstar.PARAM_HEURISTIC_FORMULA) != null) {
        if (mapParams.get(SQLFunctionAstar.PARAM_HEURISTIC_FORMULA) instanceof String) {
          ...
          ctx.paramHeuristicFormula = (HeuristicFormula) mapParams.get(SQLFunctionAstar.PARAM_HEURISTIC_FORMULA);
        }
      }
