 ...
 * @author Luca Garulli
 */
public class PSystemVariableResolver implements PVariableParserListener {
  public static final String VAR_BEGIN = "${";
  public static final String VAR_END   = "}";

  private static PSystemVariableResolver instance = new PSystemVariableResolver();
  ...
  public static String resolveSystemVariables(final String iPath, final String iDefault) {
    ...
    return (String) PVariableParser.resolveVariables(iPath, VAR_BEGIN, VAR_END, instance, iDefault);
  }
  ...
  public static void setEnv(final Map<String, String> newenv) {
    try {
      ...
      try {
        ...
        PLogManager.instance().error(PSystemVariableResolver.class, "", e2);
      }
    } catch (Exception e1) {
      PLogManager.instance().error(PSystemVariableResolver.class, "", e1);
    }
  }
}
