...
Token token;
 ...
 /*@bgen(jjtree) Projection */
    ...
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));List<OProjectionItem> items = new ArrayList<OProjectionItem>();
 ...
 /*@bgen(jjtree) Timeout */
  ...
  final public Number Wait() throws ParseException {
 /*@bgen(jjtree) Wait */
  ...
  final public Number Retry() throws ParseException {
 /*@bgen(jjtree) Retry */
