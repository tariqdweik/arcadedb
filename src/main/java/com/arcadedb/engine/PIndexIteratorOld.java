...
public class PIndexIteratorOld {
  private final PIndexLSM          index;
  private final boolean            ascendingOrder;
  private       PIndexPageIterator page;
  private       int                currentPageId;

  public PIndexIteratorOld(final PIndexLSM index, final int currentPageId, final int currentEntryInPage, final boolean ascendingOrder)
      throws IOException {
    this.index = index;
