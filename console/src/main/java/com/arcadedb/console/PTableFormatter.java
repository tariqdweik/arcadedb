...
public class PTableFormatter {
  ...
  protected       PPair<String, Boolean>           columnSorting        = null;
  ...
  public void setColumnSorting(final String column, final boolean ascending) {
    columnSorting = new PPair<String, Boolean>(column, ascending);
  }
    ...
    if (columnSorting != null) {
      Collections.sort(rows, new Comparator<Object>() {
        ...
        public int compare(final Object o1, final Object o2) {
          ...
          final PDocument doc2 = (PDocument) ((PIdentifiable) o2).getRecord();
  ...
  public PTableFormatter setMaxWidthSize(final int maxWidthSize) {
  ...
  public PTableFormatter setMaxMultiValueEntries(final int maxMultiValueEntries) {
  ...
  public static Object getPrettyFieldValue(Object value, final int multiValueMaxEntries) {
    if (value instanceof PMultiIterator<?>)
      value = getPrettyFieldMultiValue(((PMultiIterator<?>) value).iterator(), multiValueMaxEntries);
    ...
    else if (value instanceof PRecord) {
      if (((PRecord) value).getIdentity() == null) {
        value = ((PRecord) value).toString();
      } else {
        value = ((PRecord) value).getIdentity().toString();
      }
